      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-start justify-between mb-10">
          <div>
            ...
            <p className="text-slate-400 mt-1">
              ...
              <span className="text-indigo-400">Your next breach won't wait 12 months.</span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-10">
          {[
            ...
            <div key={s.label} className="bg-[#1a1d27] rounded-xl border border-slate-700 p-5">
        ...
        {vendors.length === 0 ? (
          <div className="text-center py-24">
            ...
            <p className="text-slate-600 text-sm mt-2">Add your first vendor to start monitoring.</p>
          </div>
        ) : (
